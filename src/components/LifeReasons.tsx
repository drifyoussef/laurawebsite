...
const LIFE_REASONS = [
  ...
  { emoji: '🫂', text: 'Les amis qui restent, quoi qu’il arrive.' },
  ...
  { emoji: '🩹', text: 'Le plaisir de se sentir mieux après avoir pleuré.' },
  ...
  { emoji: '🧭', text: 'Les endroits que tu n’as pas encore vus.' },
  ...
  { emoji: '💗', text: 'Le plaisir simple d’être écoutée sans jugement.' },
  ...
  { emoji: '📚', text: 'Le plaisir d’apprendre quelque chose de nouveau.' },
  { emoji: '💛', text: 'Les gens qui t’aiment telle que tu es, sans rien changer.' },
  { emoji: '😆', text: 'Un fou rire qui efface une mauvaise journée.' },
  { emoji: '🖊️', text: 'Les rêves encore à écrire.' },
  { emoji: '🌄', text: 'Le goût du premier café de la journée.' },
  ...
  { emoji: '🌆', text: 'Un ciel qui change de couleur au coucher du soleil.' },
  { emoji: '🔑', text: 'Les amis qui te connaissent par cœur.' },
  { emoji: '🏠', text: 'Le plaisir de se sentir chez soi quelque part.' },
  { emoji: '🚀', text: 'Les projets fous qu’on a envie de réaliser un jour.' },
  { emoji: '💞', text: 'Un câlin qui dure juste assez longtemps.' },
